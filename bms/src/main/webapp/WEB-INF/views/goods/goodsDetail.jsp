...
<body>
		...
		<table>
			<tbody>
				...
				<tr class="dot_line">
					...
					<td class="active">
						<fmt:formatNumber value="${goods.goodsSalesPrice*0.9}" type="number" var="discountedPrice" /> ${discountedPrice}원(10%할인)
				    </td>
				</tr>
				<tr>
	...
	<div id="container">
		<ul class="tabs">
			<li><a href="#tab1">상품목차</a></li>
			<li><a href="#tab2">저자소개</a></li>
			<li><a href="#tab3">상품소개</a></li>
