...
<body>
	<form action="${contextPath}/admin/goods/addNewGoods.do" method="post"  enctype="multipart/form-data" onsubmit="return false;">
		<h1>새상품 등록창</h1>
		...
		<div class="tab_container" id="container">
			...
			<div class="tab_container">
				<div class="tab_content" id="tab1">
					<table class="table table-bordered table-hover">			
						...
						<tr>
							<td>제품 이름</td>
							<td><input name="goodsTitle" type="text" class="form-control" required/></td>
						</tr>
						<tr>
							<td >저자</td>
							<td><input name="goodsWriter" type="text" class="form-control" required/></td>
						</tr>
						<tr>
							<td>출판사</td>
							<td><input name="goodsPublisher" type="text" class="form-control" required/></td>
						</tr>
						<tr>
							<td>제품 정가</td>
							<td><input name="goodsPrice" type="text" class="form-control" required/></td>
						</tr>
						<tr>
							<td>제품 판매가격</td>
							<td><input name="goodsSalesPrice" type="text" class="form-control" required/></td>
						</tr>
						<tr>
							<td>제품 구매 포인트</td>
							<td><input name="goodsPoint" type="text" class="form-control" required/></td>
						</tr>
						<tr>
							<td>제품출판일</td>
							<td><input  name="goodsPublishedDate" type="date" class="form-control" required/></td>
						</tr>
						<tr>
							<td>제품 총 페이지수</td>
							<td><input name="goodsTotalPage" type="text" class="form-control" required/></td>
						</tr>
						<tr>
							<td>ISBN</td>
							<td><input name="goodsIsbn" type="text" class="form-control" required/></td>
						</tr>
						<tr>
							<td>제품 배송비</td>
							<td><input name="goodsDeliveryPrice" type="text" class="form-control" required/></td>
						</tr>
						<tr>
							<td>제품 도착 예정일</td>
							<td><input name="goodsDeliveryDate" type="date" class="form-control" required/></td>
						</tr>
					</table>	
				</div>
			...
			<p align="right">
				  <input type="submit" value="등록하기" class="btn btn-outline-primary btn-sm" onClick="fn_add_new_goods(this.form)">
